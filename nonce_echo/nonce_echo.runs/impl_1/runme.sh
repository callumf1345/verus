...
HD_PWD='/home/desktop/Documents/Work/verus/nonce_echo/nonce_echo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nonce_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nonce_top.tcl -notrace
