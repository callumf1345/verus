...
HD_PWD='/home/desktop/Documents/Work/verus/nonce_echo/nonce_echo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nonce_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nonce_top.tcl
