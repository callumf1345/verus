...
HD_PWD='/home/desktop/Documents/GIT/Verushash2/verus_functions/verus_functions.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dummy_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dummy_top.tcl -notrace
