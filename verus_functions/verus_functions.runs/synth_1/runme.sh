...
HD_PWD='/home/desktop/Documents/GIT/Verushash2/verus_functions/verus_functions.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dummy_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dummy_top.tcl
